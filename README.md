...
- `docs/launch/subagent-model-strategy.md` — dedicated QA role/model routing, including Ollama/local model policy.
...
Strong models should handle final research, niche, copy, red-team, and Release Captain work. Ollama/local/smaller models may help with cheap first-pass linting and mechanical summaries, but they must not be the only judge for client-facing approval.
