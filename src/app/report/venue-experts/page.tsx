  ...
  const pricingTiers = [
    {
      name: "Snapshot",
      price: "Free",
      description: "One-time audit, up to 60 buyer questions per platform, basic score",
      features: ["Basic visibility score", "Up to 60 buyer-question coverage per platform", "Single report"],
      current: true,
      recommended: false,
    },
    {
      name: "Growth",
      price: "£XXX/mo",
      description: "Monthly audits, competitor tracking, content recommendations, paid-depth prompts",
      features: ["Full paid-depth analysis across three engines", "Monthly audits", "Competitor tracking", "Content recommendations", "Priority support"],
      current: false,
      recommended: true,
    },
    {
