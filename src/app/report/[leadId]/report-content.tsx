...
function getThemeStyles(theme: Theme) {
  if (theme === 'light') {
    return {
      ...
      textMuted: '#7B8799',
      borderSubtle: '#D4D8E0',
      borderAccent: 'rgba(37, 209, 242, 0.35)',
      glassBg: '#FFFFFF',
      glassBorder: '#D4D8E0',
      ...
      axisText: '#475569',
      ringBg: '#D9DDE3',
      shadow: '0 2px 8px rgba(0,0,0,0.06), 0 6px 20px rgba(0,0,0,0.04)',
      barBg: '#D9DDE3',
      barTrack: '#D9DDE3',
      queryBorderVisible: 'rgba(34, 197, 94, 0.35)',
      queryBorderInvisible: 'rgba(239, 68, 68, 0.35)',
      queryDotVisible: '#22C55E',
      queryDotInvisible: '#EF4444',
      queryBgVisible: 'rgba(34, 197, 94, 0.06)',
      queryBgInvisible: 'rgba(239, 68, 68, 0.06)',
      headerBg: 'rgba(240, 242, 245, 0.92)',
      headerBorder: '#D4D8E0',
      statCardTintCyan: 'rgba(37, 209, 242, 0.06)',
      statCardTintGreen: 'rgba(34, 197, 94, 0.06)',
      statCardTintAmber: 'rgba(245, 158, 11, 0.06)',
      statCardTintRed: 'rgba(239, 68, 68, 0.06)',
      radarFill: 'rgba(37, 209, 242, 0.25)',
      radarStroke: '#25D1F2',
      competitorBarYou: ['#22D3EE', '#06B6D4'],
      ctaOutlineBorder: 'rgba(37, 209, 242, 0.5)',
      ctaOutlineText: '#06B6D4',
      ctaOutlineHover: 'rgba(37, 209, 242, 0.1)',
      pricingBadgeBg: 'linear-gradient(to right, #22D3EE, #06B6D4)',
      pricingBadgeText: '#02091F',
      pricingHighlightBorder: 'rgba(37, 209, 242, 0.5)',
      footerText: 'rgba(15, 23, 42, 0.45)',
      footerLink: 'rgba(6, 182, 212, 0.8)',
  ...
  return {
    ...
    borderAccent: 'rgba(37, 209, 242, 0.3)',
    glassBg: 'rgba(19, 26, 50, 0.85)',
    glassBorder: 'rgba(37, 209, 242, 0.15)',
    glassHover: 'rgba(37, 209, 242, 0.12)',
    ...
    queryBorderVisible: 'rgba(34, 197, 94, 0.25)',
    queryBorderInvisible: 'rgba(239, 68, 68, 0.25)',
    queryDotVisible: '#22C55E',
    queryDotInvisible: '#EF4444',
    queryBgVisible: 'rgba(34, 197, 94, 0.05)',
    queryBgInvisible: 'rgba(239, 68, 68, 0.05)',
