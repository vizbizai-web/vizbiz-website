...
const navItems = [
  { id: 'dashboard', label: 'Command Center', icon: '⚡', href: '/mission-control' },
  { id: 'kanban', label: 'Missions', icon: '🎯', href: '/mission-control/kanban' },
  { id: 'agents', label: 'Agent Roster', icon: '🤖', href: '/mission-control/agents' },
  { id: 'schedule', label: 'Schedule', icon: '⏰', href: '/mission-control/schedule' },
];
