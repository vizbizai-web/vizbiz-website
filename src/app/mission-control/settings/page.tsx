...
const items = ['Stripe links', 'Resend email', 'Google Sheets CRM', 'Google Calendar', 'X account', 'llms.txt + sitemap'];

export default function Page() {
  return (
    <div className="space-y-6 pb-20 lg:pb-0">
      <div>
        <p className="text-sm font-semibold uppercase tracking-[0.22em] text-cyan-300">Configuration status without secrets</p>
        <h1 className="mt-2 text-3xl font-bold text-white sm:text-4xl">Settings / Integrations</h1>
        <p className="mt-2 max-w-3xl text-slate-400">Show whether Stripe, Resend, Google Sheets, Google Calendar, X, /llms.txt, sitemap, and production domain settings are configured.</p>
      </div>
