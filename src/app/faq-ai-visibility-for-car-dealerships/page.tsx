...
const faqItems = [
  { question: "What is VizBiz?", answer: "VizBiz helps dealerships understand how visible they are in AI-driven answers and recommendations. We show where competitors are appearing more often, what is holding visibility back, and what to improve next." },
  { question: "What is AI visibility?", answer: "AI visibility is how often your dealership appears when shoppers use tools like ChatGPT, Google AI, Perplexity, and similar systems to ask questions, compare options, and look for recommendations." },
  { question: "Why does AI visibility matter for dealerships?", answer: "More shoppers use AI tools before visiting a website or submitting a lead. If your dealership isn't being surfaced, you may be missing demand before it reaches your site." },
  { question: "What does VizBiz actually measure?", answer: "We measure how often your dealership appears, how competitors compare, which visibility categories are strong or weak, and where trust, content, inventory, authority, or technical issues may be affecting results." },
  { question: "What is the snapshot?", answer: "The snapshot is the first view — an early look at where your dealership may be visible, where competitors may be stronger, and the clearest opportunities right now." },
  ...
  { question: "What happens after I submit my information?", answer: "We organize your dealership details, prepare the visibility context, and generate the first useful view of where you stand. From there you can book a conversation or move into a deeper audit." },
  { question: "What happens on the review call?", answer: "We review your dealership type, market, goals, current weak spots, and whether VizBiz is the right fit. The goal is to decide if it makes sense to move into the audit and ongoing support." },
  ...
  { question: "What kinds of recommendations does VizBiz provide?", answer: "Recommendations may include content ideas, FAQ blocks, schema suggestions, page improvements, inventory visibility fixes, trust improvements, citation cleanup guidance, and authority-layer actions where relevant." },
  ...
  { question: "What is AVI?", answer: "AVI stands for AI Visibility Index — the client-facing score that shows how visible your dealership is across key AI-driven categories and how that changes over time." },
  { question: "What is RRF?", answer: "RRF is the internal ranking logic VizBiz uses to track how consistently your dealership appears across prompt variations and platforms, helping us understand recommendation strength and movement over time." },
  { question: "What is the authority layer?", answer: "The authority layer is the broader trust, citation, and credibility footprint around your dealership — citations, local trust signals, reviews, reputation, and other off-site signals." },
  ...
  { question: "How is this different from traditional SEO?", answer: "Traditional SEO focuses on website rankings and search traffic. VizBiz focuses on how dealerships are surfaced in AI-driven answers while using useful elements of search, trust, authority, and content strategy." },
  ...
  { question: "Who is VizBiz best for?", answer: "Dealerships that want to understand how they appear in AI-driven buying journeys and want a structured way to improve visibility over time." },
  { question: "What happens if we only want the audit?", answer: "That's fine — some dealerships may only want the one-time audit. If you want ongoing monitoring and recommendations, the retainer is the next step." },
  { question: "Why would a dealership move from the audit into a monthly retainer?", answer: "Because visibility changes over time — competitors move, prompts change, trust signals shift, and implementation takes time. The retainer helps turn the audit into ongoing improvement." },
  ...
  { question: "Is this only for sales visibility, or does it also cover service and financing?", answer: "VizBiz covers multiple visibility categories including sales, used inventory, service, financing, trust, and other areas affecting AI-driven buyer journeys." },
