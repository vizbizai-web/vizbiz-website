...
export type FixKitArtifactKey = 'A1_SCHEMA' | 'A2_LLMS' | 'A3_CRAWLER' | 'A4_META' | 'A5_FAQ' | 'A6_GBP' | 'A7_ROADMAP';
...
export type FixKitResearchPrompt = { prompt: string; businessAppeared?: boolean; provider?: string };
...
export async function generateFixKit(input: FixKitInput): Promise<FixKitResult> {
  ...
  const artifacts = [a1,a2,a3,a4,a5,a6,a7];
